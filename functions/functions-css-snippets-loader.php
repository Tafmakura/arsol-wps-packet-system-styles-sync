...
// Arsol SaaS for WooCommerce Subscriptions Plugin Styles
add_filter('arsol_wp_snippets_css_addon_files', 'arsol_wps_packet_system_styles_add_arsol_saas_woo_subscriptions_styles');
function arsol_wps_packet_system_styles_add_arsol_saas_woo_subscriptions_styles($css_options) {
    $css_options[] = array(
        'name' => 'Plugin: Arsol SaaS for WooCommerce Subscriptions',
        'file' => plugin_dir_url(__FILE__) . '../snippets/css/plugin-arsol-saas-for-woo-subscriptions.css',
        'context' => 'frontend',
        'position' => 'header',
        'priority' => 100
    );
